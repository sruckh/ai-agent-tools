...
echo ""
echo "🎯 Key benefits:"
echo "   - Truly minimal base image (~50-100MB vs ~8GB)"
echo "   - ALL dependencies installed at runtime on server"
echo "   - Automatic GPU detection and CUDA setup"
echo "   - 98%+ bandwidth reduction for container downloads"
echo "   - Persistent volume caching for faster subsequent runs"